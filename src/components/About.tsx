...
const About = () => {
  return (
    <>
      <SEO 
        title="O Nas | Progres999"
        description="Poznaj Progres999 - wiodącą platformę edukacyjną stworzoną przez profesjonalistów z branży ratownictwa medycznego. Nasza misja to podnoszenie kwalifikacji ratowników poprzez wysokiej jakości kursy online."
        keywords="ratownictwo medyczne, kursy online, edukacja medyczna, szkolenia, certyfikaty"
        ogType="website"
        ogImage="/logo.png"
      />
